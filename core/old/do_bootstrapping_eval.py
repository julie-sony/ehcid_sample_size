...
def run(task_model, acc_path, save_dir, p_group):
    ...
    total_bootstrap_ci = bootstrap(acc, np.mean, confidence_level = 0.95, 
    ...
    save_data_path = save_dir + '/' + task_model + '_bootsrapping_results_'+p_group+'.csv'
